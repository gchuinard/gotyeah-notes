...
### Les 37 outils `notes_*` (état du code, `remote.py`)

- **Pages / sections (10)** : `notes_list_workspaces`, `notes_list_pages`, `notes_get_page`, `notes_create_page`, `notes_update_page`, `notes_move_page`, `notes_delete_page`, `notes_search`, `notes_list_sections`, `notes_create_section`.
